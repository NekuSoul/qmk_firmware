...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [_LAYER1] = LAYOUT_65_ansi( /* Function keys */
            ...
            KC_TRNS,  _______,  _______,  _______,  _______,_______,_______,_______,_______,  _______,  _______,            _______,   _______,    _______,\
            KC_TRNS,  KC_TRNS,  KC_TRNS,                    _______,                _______,  _______,  _______,            _______,   _______,    _______),
        [_LAYER2] = LAYOUT_65_ansi( /* Keyboard control */
            ...
            _______,  RGB_VAD,  RGB_HUD,  RGB_SAD,  _______,_______,_______,_______,_______,  _______,  _______,            RGB_TOG,   RGB_SPI,    _______,\
            _______,  _______,  _______,                    _______,                KC_TRNS,  _______,  _______,            RGB_RMOD,  RGB_SPD,    RGB_MOD),
        [_LAYER3] = LAYOUT_65_ansi( /* Virtual Numpad */
            _______,  _______,  _______,  _______,  _______,_______,_______,KC_P7,  KC_P8,    KC_P9,    KC_PSLS,  _______,  _______,   KC_TRNS,    KC_TRNS,\
            _______,  _______,  _______,  _______,  _______,_______,_______,KC_P4,  KC_P5,    KC_P6,    KC_PAST,  _______,  _______,   _______,    _______,\
            _______,  _______,  _______,  _______,  _______,_______,_______,KC_P1,  KC_P2,    KC_P3,    KC_PMNS,  _______,             KC_TRNS,    _______,\
            KC_TRNS,  _______,  _______,  _______,  _______,_______,_______,KC_P0,  KC_PDOT,  KC_PENT,  KC_PPLS,            _______,   _______,    _______,\
            KC_TRNS,  KC_TRNS,  KC_TRNS,                    _______,                _______,  KC_TRNS,  _______,            _______,   _______,    _______),
        [_LAYER4] = LAYOUT_65_ansi( /* Indicator customization */
            _______,  _______,  _______,  _______,  _______,_______,_______,_______,_______,  _______,  _______,  _______,  _______,   _______,    _______,\
            _______,  _______,  _______,  _______,  _______,_______,_______,_______,_______,  _______,  _______,  _______,  _______,   _______,    _______,\
            _______,  _______,  _______,  _______,  _______,_______,_______,_______,_______,  _______,  _______,  _______,             _______,    _______,\
            _______,  _______,  _______,  _______,  _______,_______,_______,_______,_______,  _______,  _______,            _______,   _______,    _______,\
            _______,  _______,  _______,                    _______,                KC_1,     _______,  KC_TRNS,            _______,   _______,    _______),
};
